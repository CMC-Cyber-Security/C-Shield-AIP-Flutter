...
/// Result of normalizing a request/response body for AP signing.
///
/// Mirrors `BodySigningResult` on Android (Kotlin) and iOS (Swift).
class APBodySigningResult {
...
/// Pure-Dart port of the native body normalization
...
class APNormalizer {
  ...
  static APBodySigningResult normalizeBodyForSigning({
    required Uint8List body,
    required String contentType,
  }) {
    if (body.isEmpty) {
      return APBodySigningResult(
        normalizedString: '',
        sizeInBytes: 0,
