...
class CShieldSSL {
  ...
  static Future<void> configure({required List<String> pins, required String hostname}) async {
    ...
    await CShieldAipPlatform.instance.sslConfigure(pins: pins, hostname: hostname);
  ...
  static Future<bool> isConfigured() => CShieldAipPlatform.instance.sslIsConfigured();
  ...
  static Future<bool> verifyPin({required String certDerBase64, required String host}) => CShieldAipPlatform.instance.sslCheckServerTrusted(certDerBase64: certDerBase64, host: host);
